...
class SendHistoriesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create send_history" do
    assert_difference('SendHistory.count') do
      post send_histories_url, params: { send_history: { amount: @send_history.amount, from_user_id: @send_history.from_user_id, send_type: @send_history.send_type } }
    end
  ...
  test "should update send_history" do
    patch send_history_url(@send_history), params: { send_history: { amount: @send_history.amount, from_user_id: @send_history.from_user_id, send_type: @send_history.send_type } }
